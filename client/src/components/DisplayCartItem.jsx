  ...
  return (
    <section className="bg-neutral-900 fixed top-0 bottom-0 right-0 left-0 bg-opacity-70 z-50">
      <div className="bg-white w-full max-w-sm min-h-screen max-h-screen ml-auto">
        ...
        <div className="min-h-[75vh] lg:min-h-[80vh] h-full max-h-[calc(100vh-150px)] bg-blue-50 p-2 flex-col gap-4 flex ">
          {/* display item */}
          {cartItem[0] ? (
            <>
              <div className="flex items-center justify-between px-4 py-2 bg-blue-100 text-blue-500 rounded-full">
                <p>Your Total Savings</p>
                <p>{DisplayPriceRupees(notDiscountTotalPrice - totalPrice)}</p>
              </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="w-full max-w-sm text-xs">
                          <p className="text-xs text-allipsis line-clamp-2">
                            {item?.productId?.name}
                          </p>
        ...
        {cartItem[0] && (
          <div className="p-2">
            <div className="bg-green-700 text-neutral-100 px-4 font-bold text-base py-4 static bottom-3 flex items-center justify-between rounded">
