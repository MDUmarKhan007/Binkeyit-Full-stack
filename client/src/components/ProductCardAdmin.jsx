...
const ProductCardAdmin = ({ data, fetchPrdouctData }) => {
    ...
    <div className="w-36 p-4 bg-white rounded">
      ...
      <div className="grid grid-cols-2 gap-3 py-2">
        ...
        <button
          ...
          className="border px-1 py-1 text-sm border-green-500 bg-green-100 text-green-800 hover:bg-green-200 rounded"
        >
          Delete
        </button>
      </div>
      ...
      {editOpen && (
        <EditProductAdmin
          fetchPrdouctData={fetchPrdouctData}
          data={data}
