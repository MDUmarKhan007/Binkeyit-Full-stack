...
const EditSubCategory = ({ close, fetchData, data }) => {
  ...
  const handleRemoveCategorySelectod = (categoryId) => {
  ...
  return (
    <section className="fixed top-0 right-0 bottom-0 left-0 bg-neutral-800 bg-opacity-70 Z-50 flex justify-center items-center p-4">
        ...
        <form className="my-3 grid gap-3" onSubmit={handleSubmitSubCategory}>
          ...
          <div className="grid gap-1">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-3">
              ...
              <label htmlFor="uploadSubCategorytImage">
            ...
            <div className="border focus-within:border-primary-200 rounded">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        ...
                        onClick={() => handleRemoveCategorySelectod(cat._id)}
                      >
                        <IoClose size={20} />
                      </div>
                    </p>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  const categeryDetails = allCategory.find(
                    (el) => el._id == value
                  );
                  setSubCategoryData((preve) => {
                    return {
                      ...preve,
                      category: [...preve.category, categeryDetails],
                    };
                  });
                }}
              >
