...
const ProductDisplayPage = () => {
  ...
  return (
    <section className="container mx-auto p-4 grid lg:grid-cols-2">
      {/* left part */}
      <div className="">
        <div className="bg-white lg:min-h-[65vh] backdrop:lg:max-h-[65vh] rounded min-h-56 max-h-56 h-full w-full">
          <img
      ...
      <div className="p-4 lg:pl-7 text-base lg:text-lg">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            {data.discount && (
              <p className="line-through">{DisplayPriceRupees(data.price)}</p>
            )}
